...
export const EuropeanUnion = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`european-union ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_9881_3791)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_9881_3791">
