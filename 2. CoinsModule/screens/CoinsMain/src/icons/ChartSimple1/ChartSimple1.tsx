...
export const ChartSimple1 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`chart-simple-1 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_9752_1833)"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke="url(#paint1_linear_9752_1833)"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.2"
      />
      ...
      <path
        ...
        stroke="url(#paint2_linear_9752_1833)"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.2"
      />
